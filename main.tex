...
Mixes analysis with hardware concerns, but fast. & High-level abstractions data analysis, but geared toward batch processes. & Dynamic, interactive; ideal the compute-plot- think cycle.
\end{tabular}
\end{frame}

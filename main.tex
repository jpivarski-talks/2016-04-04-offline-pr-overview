...
\begin{tabular}{l >{\centering}p{0.08\linewidth} >{\centering}p{0.15\linewidth} >{\centering}p{0.08\linewidth} p{0.4\linewidth}}
...
\textcolor{darkblue}{filter} & list of $A$ & $f: A \to \mbox{bool}$ & list of $A$ & get a shorter list \\

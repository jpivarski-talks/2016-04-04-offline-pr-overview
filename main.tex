...
Also includes a pure-C++ {\tt root2avro} for streaming or bulk file conversion.
\end{frame}
...
\begin{frame}[fragile]{Used in developing analysis}
\begin{columns}
\column{0.5\linewidth}
Working with Oliver Gutsche, Matteo Cremonesi, and Cristina Su\'arez to perform a monojet analysis using Apache Spark. This plot came from a skimming job performed in Spark.

Part of a larger effort including Alexey Svyatkovskiy (Princeton), Saba Sehrish and Jim Kowalkowski (FNAL Scientific Computing).
\column{0.5\linewidth}

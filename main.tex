...
\begin{block}{2006}
\begin{columns}{0.8\linewidth}
Hadoop project started, mainly by Yahoo! but within Apache open-source.
\begin{columns}{0.2\linewidth}
\includegraphics[width=\linewidth]{01_Hadoop_full.jpg}
\end{columns}
\end{block}
...
\begin{columns}{0.2\linewidth}
\includegraphics[width=\linewidth]{spark-logo.png}
\end{columns}
\end{block}

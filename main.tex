...
\begin{itemize}
\item The ``map'' primitive says less than ``for''--- it doesn't specify an order for the events to be processed.
\item Underlying system can distribute and collect however it likes.
\item Also doesn't involve the data analyst in indexing over subsets of data.
\end{itemize}
\end{frame}

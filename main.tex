...
\hspace{-0.83 cm} \textcolor{darkblue}{\Large So we can run physics events through Big Data tools.}

\vspace{0.3 cm}
\hspace{-0.83 cm} \textcolor{darkblue}{\Large What does that buy us?}

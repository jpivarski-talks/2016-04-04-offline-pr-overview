...
\textcolor{darkblue}{aggregate} & table of $A$, initial value $B$ & $f: (A, B) \to B$ and $f: (B, B) \to B$ & single value $B$ & accumulate a counter with a different data type from the input \\

...
\begin{frame}{Tightly coupled problems}

\begin{block}{Most physics analyses}
To process one event, you don't need to know about any other events.
\end{block}

\begin{block}{Most industrial problems}
Require large datasets to be transposed, regrouping distributed datasets from one lookup key to another.
\end{block}

...
\begin{center}
\includegraphics[width=0.3\linewidth]{streaming-1.png} \hfill
\includegraphics[width=0.3\linewidth]{streaming-2.png}

\includegraphics[width=0.5\linewidth]{streaming-3.png}

\includegraphics[width=0.3\linewidth]{streaming-4.png} \hfill
\includegraphics[width=0.3\linewidth]{streaming-5.jpg}
\end{center}

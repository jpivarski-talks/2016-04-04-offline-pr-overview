...
\vspace{1.5 cm}
The major tools are available through package managers (Maven Central, PyPI, CRAN, \ldots), and there are third-party adapters between just about every pair of them.
\end{minipage}
\end{center}
\end{frame}

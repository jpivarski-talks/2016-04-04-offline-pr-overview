...
\begin{tabular}{l >{\centering}p{0.23\linewidth} c >{\centering}p{0.23\linewidth} p{0.5\linewidth}}
& input & function & output & operation \\\hline
\textcolor{darkblue}{map} & list of $A$ & $f: A \to B$ & list of $B$ & apply $f$ to each $A$, get a new list with the same length \\
\end{tabular}

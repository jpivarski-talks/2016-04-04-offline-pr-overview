...
\vfill
However, {\tt Pack\_O\_Histograms} is a bit like a meta-histogram, where the string names are the bins of the meta-histogram. Its methods, {\tt FillAll} and {\tt AddAll} satisfy the same monoid rules.

...
\begin{itemize}
\item I'm a CMS physicist, contributed to muon alignment in Run-1 commissioning.
\item I spent five years as a data science consultant in industry.
\begin{itemize}
\item Helped commercial clients analyze datasets with Big Data technologies: Hadoop, Spark, NoSQL, etc. Some statistics, some software development.
\end{itemize}
\end{itemize}

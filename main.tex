...
\vspace{1.8 cm}
But perhaps we can use what's out there and let the Big Data community maintain it. Most of these tools are available through package managers (Maven Central, PyPI, CRAN, \ldots).
\end{minipage}
\end{center}
\end{frame}

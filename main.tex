...
\begin{center}
\begin{tabular}{p{0.5\linewidth} p{0.6\linewidth}}
CSV, JSON, XML\ldots & Text-based for human readability; more common than you'd think. \\
Avro, Thrift, and Protocol buffers\ldots & Generic, row-based binary data, like JSON with a schema. \\
Parquet, ORC, RCFile\ldots & Generic, columnar binary data, used for SQL-style analyses. \\
Java serialization, Kryo, Hadoop Writables\ldots & Intermediate serialization for data in a distributed stream. \\

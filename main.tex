...
Mixes analysis with hardware concerns. & High-level abstractions data analysis, but better suited to batch processes than interactivity. & Best for the compute-plot-think cycle.
\end{tabular}
\end{frame}

...
Mixes analysis with hardware concerns. & High-level abstractions data analysis, but geared toward batch processes. & Highly interactive; ideal the compute- plot-think cycle.
\end{tabular}
\end{frame}

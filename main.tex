...
\begin{columns}
\column{0.5\linewidth}
Extensive distributed data filtering and transformations (``map'' from map-reduce).

\column{0.5\linewidth}
Extensive distributed map and reduce: data association problems.
\end{columns}
...
\column{0.5\linewidth}
Increasing use of functional primitives: map, filter, flatMap, reduce, aggregate, aggregateByKey.

...
\vfill
However, {\tt Pack\_O\_Histograms} is a bit like a meta-histogram, where the names are bins and the values are the stored histograms. Its methods, {\tt FillAll} and {\tt AddAll} satisfy the same monoid rules and play the same role.

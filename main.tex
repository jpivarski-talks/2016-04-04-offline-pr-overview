...
Mixes analysis with hardware concerns. & High-level abstractions data analysis, but better suited to batch processes. & Highly dynamic, great for interactive tinkering.
\end{tabular}
\end{frame}

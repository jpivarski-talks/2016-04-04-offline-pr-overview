...
\textcolor{darkblue}{aggregate} & table of $A$, initial value $B$ & $f: (A, B) \to B$ $f: (B, B) \to B$ (increment and combine) & single value $B$ & accumulate a counter with a different data type from the input \\

...
\xdefinecolor{darkgrey}{rgb}{0.25,0.25,0.25}
...
\item \textcolor{darkgrey}{Combining Scala macros with ROOT's Cling interface to create Java interfaces with C++ implementations.}
\end{itemize}
\end{block}
\end{uncoverenv}
\end{frame}

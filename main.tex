...
\begin{center}
\includegraphics[width=0.5\linewidth]{streaming-1.png}
\includegraphics[width=0.5\linewidth]{streaming-2.png}

\includegraphics[width=0.5\linewidth]{streaming-3.png}

\includegraphics[width=0.5\linewidth]{streaming-4.png}
\includegraphics[width=0.5\linewidth]{streaming-5.png}
\end{center}

...
\begin{tabular}{l c c c p{0.7\linewidth}}
\textcolor{darkblue}{map} & list of $A$ & $f: A \to B$ & list of $B$ & Applies $f$ independently to each element, produces a new list of the same length. \\
\end{tabular}

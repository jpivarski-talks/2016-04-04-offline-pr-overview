...
\item Map-reduce framework optimizes the sorting and merging needed to collect unique keys.
\end{itemize}

\begin{center}
\includegraphics[width=0.75\linewidth]{mapreduce-diagram-by-ibm.png}
\end{center}
\end{frame}

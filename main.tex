...
Need to reindex data from words-in-webpages to webpages-with-words.
...
Need to reindex data from residuals-on-tracks to residuals-on-subdetectors.
...
\item Currently, detector groups are reimplementing this in custom ways.
\end{itemize}

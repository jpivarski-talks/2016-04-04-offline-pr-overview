...
\vspace{0.2 cm}
Spark can cache mapper data in RAM to avoid the cost of re-loading from disk.
\column{0.35\linewidth}
\includegraphics[width=\linewidth]{spark_time.png}
\end{columns}

\begin{itemize}
\item I primarily used Hadoop in industry, but have been working with Spark for the last few weeks.
\item In addition to the speedup, Spark has many minor conveniences for data analysis: boilerplate becomes one-liners.
\end{itemize}

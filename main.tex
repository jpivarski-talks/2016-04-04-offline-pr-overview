...
But currently, the aggregation is performed using imperative analysis scripts with containers designed around their graphical representation. Imagine if they could be built from a few small building blocks?
